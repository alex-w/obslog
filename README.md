...
All these elements can be conveniently described in a informational model that captures the essentials in an unambiguous and uncomplicated way, while minimizing bureacracy and maximizing usefulness for the purposes of a given user.
